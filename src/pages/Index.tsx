        ...
        <div className="w-full px-4 md:px-8">
          ...
          <div className="banner-roll-in w-full max-w-4xl px-4 mx-auto mt-12 animate-heartbeat">
            <div
              ...
              ref={bannerRef}
            >
              <img src="https://cdn.poehali.dev/projects/53d4eefc-24fa-41e9-b99a-3ee269a34aaf/bucket/738536a8-6f47-4c37-8051-53a64e0016d2.jpg" alt="Акция — газобетон 13 500 руб. м³, бесплатное хранение до конца июня" className="w-full h-auto rounded-2xl mx-0 px-0 py-[5px] my-0 object-contain" />
            </div>
          </div>
        </div>
      </section>
