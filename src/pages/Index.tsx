...
const Index = () => {
  ...
  return (
    ...
    <div ref={containerRef} className="min-h-screen bg-[#F8F8F8]">
      ...
      >
        <div className="max-w-[1200px] mx-auto px-4 md:px-8 text-center text-white pb-16 md:pb-24 pt-32">
        ...
        <div className="w-full px-4 md:px-8">
          ...
          <div className="banner-roll-in w-full max-w-4xl px-4 mx-auto mt-12 animate-heartbeat">
            <div
              ...
              ref={bannerRef}
            >
              <img src="https://cdn.poehali.dev/projects/53d4eefc-24fa-41e9-b99a-3ee269a34aaf/bucket/38b2091f-8d89-4789-8b78-c634213c62f1.jpg" alt="Акция — газобетон 14 000 руб. м³, бесплатное хранение до конца месяца" className="w-full h-auto rounded-2xl mx-0 px-0 py-[5px] my-0 object-contain" />
            </div>
          </div>
        </div>
      </section>
